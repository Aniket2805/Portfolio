                ...
                <div className="row contact-box">
                        ...
                        <Zoom top>
                            <div className="reach-box">
                                <div className="reach-box-l">
                                    <a href="https://goo.gl/maps/uJgEGGM9LhpiCjXu9" target="_blank"><i
                                        className="fa-solid fa-location-dot fa-2x contact-icon"
                                        style={{ color: "white", width: "4.2rem", height: "4.2rem", textAlign: "center" }}></i></a>
                                </div>
                    ...
                    <Zoom right>
                        <div className="col-lg-6 contact-right" style={{ padding: "40px" }}>
                            <form action="mailto:aniketrocks2468@gmail.com" method="post" enctype="text/plain">
                                <h2>Write us</h2>
                                ...
                                <div className="inputbox">
                                    <textarea name="Message" id="textarea" cols="30" rows="4" required="required"></textarea>
